...
int main() {
  ...
  for (auto n : sizes) {
    ...
    pt::contains<bt::dynamic_set<float>, float>(counter, n);
    ...
    pt::contains<absl::btree_set<float>, float>(counter, n);
