...
NUMS;
BENCHMARK(
    BM_contains<std::flat_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
...
NUMS;
BENCHMARK(
    BM_access<absl::btree_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_contains<absl::btree_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_remove<absl::btree_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_insert<absl::btree_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
#endif
...
NUMS;
BENCHMARK(
    BM_access<bt::dynamic_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_contains<bt::dynamic_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_remove<bt::dynamic_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
BENCHMARK(
    BM_insert<bt::dynamic_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
#endif
...
NUMS;
BENCHMARK(
    BM_contains<bt::static_set<pt::Decimal<int64_t>>, pt::Decimal<int64_t>>)
NUMS;
#endif
